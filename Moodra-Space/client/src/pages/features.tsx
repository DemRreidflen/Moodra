  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        subtitle: "A three-panel studio that keeps all your research connected to your book — no switching tools.",
        items: [
          "AI Source Search — describe what you need, get structured results with authors, key points, quotes, and relevance scores",
          "Save any result to your Source Library with one click",
          "Drafts panel — write and edit full research drafts using the same block editor as the main book",
          "Autosave on every change — never lose a draft",
          "Move draft to book: insert as a new chapter or append to an existing one",
          "Role Models — add author analyses, view full style breakdowns with expandable sections",
