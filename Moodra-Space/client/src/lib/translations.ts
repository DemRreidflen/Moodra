...
**What you write changes how you think.** This is the loop that serious writers discover: writing changes your mind. Not because writing is magical, but because the discipline of having to defend claims on the page, to find evidence, to anticipate objections, to organize arguments — these processes reshape the underlying thinking. People who write seriously about a subject understand it more deeply than people who merely study it. The writing is not reporting on the understanding. The writing produces it. This is why writing matters even when no one else will read it — especially then, because there is no external purpose to satisfy and the only thing happening is the thinking itself.`,
    ...
    layoutPanel: {
      ...
      editModeOn: "Edit",
      editModeOff: "Exit editing",
      layoutUpdating: "Updating…",
      layoutOnboardingTitle: "Welcome to Layout Mode",
      layoutOnboardingStep1Title: "Full book preview",
      layoutOnboardingStep1Desc: "See your book exactly as it will be printed — with covers, headers, footers, and automatic pagination via Paged.js.",
      layoutOnboardingStep2Title: "Inline editing",
      layoutOnboardingStep2Desc: "Click \"Edit\" in the toolbar to type directly on the page. Changes save automatically and the preview updates when you exit editing.",
      layoutOnboardingStep3Title: "Export",
      layoutOnboardingStep3Desc: "Export your finished book as PDF (print-ready), DOCX (for editing), or EPUB (for e-readers) — all from the toolbar.",
      layoutOnboardingGotIt: "Got it",
      layoutOnboardingNext: "Next",
      layoutOnboardingPrev: "Back",
...
**То, что вы пишете, меняет то, как вы думаете.** Это петля, которую серьёзные авторы открывают: письмо меняет ваш разум. Не потому что письмо магично, а потому что дисциплина защиты утверждений на странице, поиска доказательств, предвидения возражений — эти процессы перестраивают мышление. Люди, серьёзно пишущие на тему, понимают её глубже людей, просто изучающих её. Письмо производит понимание. Вот почему письмо важно, даже когда — особенно когда — никто другой его не прочитает.`,
    ...
    layoutPanel: {
      ...
      editModeOn: "Редактировать",
      editModeOff: "Выйти из редактора",
      layoutUpdating: "Обновление…",
      layoutOnboardingTitle: "Добро пожаловать в режим верстки",
      layoutOnboardingStep1Title: "Полный предпросмотр книги",
      layoutOnboardingStep1Desc: "Видите книгу так, как она будет напечатана — с обложкой, колонтитулами и автоматической пагинацией.",
      layoutOnboardingStep2Title: "Редактирование прямо на странице",
      layoutOnboardingStep2Desc: "Нажмите «Редактировать» в тулбаре — и печатайте прямо на странице. Изменения сохраняются автоматически.",
      layoutOnboardingStep3Title: "Экспорт",
      layoutOnboardingStep3Desc: "Экспортируйте готовую книгу в PDF (для печати), DOCX (для редактирования) или EPUB (для ридеров) — из тулбара.",
      layoutOnboardingGotIt: "Понятно",
      layoutOnboardingNext: "Далее",
      layoutOnboardingPrev: "Назад",
...
**Те, що ви пишете, змінює те, як ви думаєте.** Це петля, яку серйозні автори відкривають: письмо змінює ваш розум. Не тому що письмо магічне, а тому що дисципліна захисту тверджень на сторінці, пошуку доказів, передбачення заперечень — ці процеси перебудовують мислення. Люди, що серйозно пишуть на тему, розуміють її глибше за людей, які лише вивчають її. Письмо виробляє розуміння. Ось чому письмо важливе, навіть коли — особливо коли — ніхто інший його не прочитає.`,
    ...
    layoutPanel: {
      ...
      editModeOn: "Редагувати",
      editModeOff: "Вийти з редагування",
      layoutUpdating: "Оновлення…",
      layoutOnboardingTitle: "Ласкаво просимо до режиму верстки",
      layoutOnboardingStep1Title: "Повний попередній перегляд",
      layoutOnboardingStep1Desc: "Бачите книгу такою, якою вона буде надрукована — з обкладинкою, колонтитулами та автоматичною пагінацією.",
      layoutOnboardingStep2Title: "Редагування прямо на сторінці",
      layoutOnboardingStep2Desc: "Натисніть «Редагувати» на панелі — і друкуйте прямо на сторінці. Зміни зберігаються автоматично.",
      layoutOnboardingStep3Title: "Експорт",
      layoutOnboardingStep3Desc: "Експортуйте готову книгу у PDF (для друку), DOCX (для редагування) або EPUB (для рідерів) — з панелі інструментів.",
      layoutOnboardingGotIt: "Зрозуміло",
      layoutOnboardingNext: "Далі",
      layoutOnboardingPrev: "Назад",
...
**Was du schreibst, verändert, wie du denkst.** Das ist die Schleife, die ernsthafte Schriftsteller entdecken: Schreiben verändert deinen Verstand. Nicht weil Schreiben magisch ist, sondern weil die Disziplin, Behauptungen auf der Seite zu verteidigen, Beweise zu finden, Einwände zu antizipieren — diese Prozesse das zugrundeliegende Denken umgestalten. Menschen, die ernsthaft über ein Thema schreiben, verstehen es tiefer als Menschen, die es nur studieren. Das Schreiben ist nicht der Bericht über das Verständnis. Das Schreiben produziert es.`,
    ...
    layoutPanel: {
      ...
      editModeOn: "Bearbeiten",
      editModeOff: "Bearbeitung beenden",
      layoutUpdating: "Wird aktualisiert…",
      layoutOnboardingTitle: "Willkommen im Layout-Modus",
      layoutOnboardingStep1Title: "Vollständige Buchvorschau",
      layoutOnboardingStep1Desc: "Sehen Sie Ihr Buch genau so, wie es gedruckt wird — mit Umschlag, Kopf- und Fußzeilen sowie automatischer Seitennummerierung.",
      layoutOnboardingStep2Title: "Direkt auf der Seite bearbeiten",
      layoutOnboardingStep2Desc: "Klicken Sie auf «Bearbeiten» in der Symbolleiste, um direkt auf der Seite zu schreiben. Änderungen werden automatisch gespeichert.",
      layoutOnboardingStep3Title: "Export",
      layoutOnboardingStep3Desc: "Exportieren Sie Ihr fertiges Buch als PDF (druckfertig), DOCX (zum Bearbeiten) oder EPUB (für E-Reader) — direkt aus der Symbolleiste.",
      layoutOnboardingGotIt: "Verstanden",
      layoutOnboardingNext: "Weiter",
      layoutOnboardingPrev: "Zurück",
