  ...
  layout: {
    ...
    steps: {
      en: [
        ...
        { title: "Export", body: "Export your book as PDF or EPUB. The layout settings are applied to the PDF export. EPUB includes embedded fonts and cover." },
      ],
      ru: [
        ...
        { title: "Экспорт", body: "Экспортируйте книгу в PDF или EPUB. Настройки вёрстки применяются к экспорту PDF. EPUB включает встроенные шрифты и обложку." },
      ],
      ua: [
        ...
        { title: "Експорт", body: "Експортуйте книгу в PDF або EPUB. Налаштування вёрстки застосовуються до експорту PDF. EPUB включає вбудовані шрифти та обкладинку." },
      ],
      de: [
        ...
        { title: "Export", body: "Exportieren Sie Ihr Buch als PDF oder EPUB. Die Layout-Einstellungen werden auf den PDF-Export angewendet." },
      ],
    },
  },
};
